...
class BinaryData
{
    ...
    public:
        ...
        inline std::string  artist()const   { return _artist;}
        inline std::string  type()  const   { return _type;  }
        inline const int&   year()  const   { return _year;  }
        inline const int&   price() const   { return _price; }
        inline const int&   count() const   { return _count; }
        inline const bool&  is_deleted() const { return _del;}
